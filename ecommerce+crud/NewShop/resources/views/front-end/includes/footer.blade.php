...
<div class="copy-section">
    <div class="container">
        <div class="copy-left">
            <p>&copy; 2019 New Shop . All rights reserved | Developed by <a href="http://w3layouts.com">Sarjis Muhammad
                    Abdullah</a></p>
        </div>
                        ...
                        <div class="women">
                            ...
                            <div class="add">
                                <button class="btn btn-danger my-cart-btn my-cart-b" data-id="3"
                                        ...
                                        data-quantity="1" data-image="{{asset('/')}}front-end/images/of2.png">Add to
                                    Cart
                                </button>
                            </div>
                        </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content modal-info">
            ...
            <div class="modal-body">
                <div class="news-gr">
                    <div class="col-md-5 new-grid1">
                        <img src="{{asset('/')}}front-end/{{asset('/')}}front-end/images/p12.jpg" class="img-responsive"
                             alt="">
                    </div>
                    <div class="col-md-7 new-grid">
                        <h5>Ten Men's Cotton Viscose fabric Grey Shrug</h5>
