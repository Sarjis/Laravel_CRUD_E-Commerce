                        ...
                        <div class="top-rates">
                            ...
                            <div class="recent-grids">
                                ...
                                <div class="recent-right">
                                    ...
                                    <p>
                                        <del>$100.00</del>
                                        <em class="item_price">$09.00</em></p>
                                </div>
                            ...
                            <div class="recent-grids">
                                ...
                                <div class="recent-right">
                                    ...
                                    <p>
                                        <del>$100.00</del>
                                        <em class="item_price">$19.00</em></p>
                                </div>
                                <div class="clearfix"></div>
                            </div>
                            <div class="recent-grids">
                                ...
                                <div class="recent-right">
                                    ...
                                    <p>
                                        <del>$100.00</del>
                                        <em class="item_price">$39.00</em></p>
                                </div>
                                <div class="clearfix"></div>
                            </div>
                            <div class="recent-grids">
                            ...
                            <ul id="myTab" class="nav1 nav1-tabs left-tab" role="tablist">
                                <ul id="myTab" class="nav nav-tabs left-tab" role="tablist">
                                    <li role="presentation" class="active"><a href="#home" id="home-tab" role="tab"
                                                    ...
                                                    src="{{asset('/')}}front-end/images/menu1.png"></a></li>
                                    <li role="presentation"><a href="#profile" role="tab" id="profile-tab"
                                                               data-toggle="tab" aria-controls="profile"><img
                                                    src="{{asset('/')}}front-end/images/menu.png"></a></li>
                                </ul>
                                <div id="myTabContent" class="tab-content">
                                    <div role="tabpanel" class="tab-pane fade in active" id="home"
                                         aria-labelledby="home-tab">
                                        <div class="product-tab">
                                            {{--First presentation of product START--}}
                                                ...
                                                <div class="col-md-4 product-tab-grid simpleCart_shelfItem">
                                                    <div class="grid-arr">
                                                            ...
                                                            <figure>
                                                                <a href="#" class="new-gri" data-toggle="modal"
                                                                   data-target="#myModal1">
                                                                    <div class="grid-img">
                                                                        <img src="{{asset($brandProduct->product_image)}}"
                                                        ...
                                                        <div class="women">
                                                            ...
                                                            <p>
                                                                <del>{{$brandProduct->product_price}}</del>
                                                                <em class="item_price">$70.00</em></p>
                                                            <a href="#" data-text="Add To Cart"
                                                               class="my-cart-b item_add">Add
                                                                To Cart</a>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div role="tabpanel" class="tab-pane fade" id="profile"
                                        ...
                                        {{--second presentation of product START--}}
                                        @foreach($brandProducts as $brandProduct)
                                            ...
                                            <div class="product-tab1">
                                                ...
                                                <div class="col-md-8 product-tab1-grid1 simpleCart_shelfItem">
                                                    ...
                                                    <div class="women">
                                                        <h6><a href="single.html">Sed ut perspiciatis unde</a></h6>
                                                        <span class="size">XL / XXL / S </span>
                                                        <p>{!!$brandProduct->long_description !!} </p>
                                                        <p>
                                                            <del>$100.00</del>
                                                            <em class="item_price">{{$brandProduct->short_description}}</em></p>
                                            ...
                                            {{--second presentation of product END--}}
                                        @endforeach
