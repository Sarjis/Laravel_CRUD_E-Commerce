                        ...
                        <div class="col-md-3 arrival-grid simpleCart_shelfItem">
                            <div class="grid-arr">
                                ...
                                <div class="women">
                                    ...
                                    <p>
                                        <del>$100.00</del>
                                        <em class="item_price">{{$newProduct->product_price}} Tk.</em></p>
                                        ...
                                        <div class="grid-arr">
                                            <div class="grid-arrival">
                                                <figure>
                                                    <a href="single.html">
                                                        <div class="grid-img">
                                                            <img src="{{asset('/')}}front-end/images/p14.jpg"
                                                                 class="img-responsive" alt="">
                                                        </div>
                                                        <div class="grid-img">
                                                            <img src="{{asset('/')}}front-end/images/p13.jpg"
                                                                 class="img-responsive" alt="">
                                                        </div>
                                                    </a>
                                                </figure>
                                        ...
                                        <div class="grid-arr">
                                            <div class="grid-arrival">
                                                <figure>
                                                    <a href="single.html">
                                                        <div class="grid-img">
                                                            <img src="{{asset('/')}}front-end/images/p15.jpg"
                                                                 class="img-responsive" alt="">
                                                        </div>
                                                        <div class="grid-img">
                                                            <img src="{{asset('/')}}front-end/images/p16.jpg"
                                                                 class="img-responsive" alt="">
                                                        </div>
                                                    </a>
                                                </figure>
                                        ...
                                        <div class="grid-arr">
                                            <div class="grid-arrival">
                                                <figure>
                                                    <a href="single.html">
                                                        <div class="grid-img">
                                                            <img src="{{asset('/')}}front-end/images/p18.jpg"
                                                                 class="img-responsive" alt="">
                                                        </div>
                                                        <div class="grid-img">
                                                            <img src="{{asset('/')}}front-end/images/p17.jpg"
                                                                 class="img-responsive" alt="">
                                                        </div>
                                                    </a>
                                                </figure>
                                        ...
                                        <div class="grid-arr">
                                            <div class="grid-arrival">
                                                <figure>
                                                    <a href="single.html">
                                                        <div class="grid-img">
                                                            <img src="{{asset('/')}}front-end/images/p20.jpg"
                                                                 class="img-responsive" alt="">
                                                        </div>
                                                        <div class="grid-img">
                                                            <img src="{{asset('/')}}front-end/images/p19.jpg"
                                                                 class="img-responsive" alt="">
                                                        </div>
                                                    </a>
                                                </figure>
                                        ...
                                        <div class="grid-arr">
                                            <div class="grid-arrival">
                                                <figure>
                                                    <a href="single.html">
                                                        <div class="grid-img">
                                                            <img src="{{asset('/')}}front-end/images/p21.jpg"
                                                                 class="img-responsive" alt="">
                                                        </div>
                                                        <div class="grid-img">
                                                            <img src="{{asset('/')}}front-end/images/p22.jpg"
                                                                 class="img-responsive" alt="">
                                                        </div>
                                                    </a>
                                                </figure>
                                        ...
                                        <div class="grid-arr">
                                            <div class="grid-arrival">
                                                <figure>
                                                    <a href="single.html">
                                                        <div class="grid-img">
                                                            <img src="{{asset('/')}}front-end/images/p24.jpg"
                                                                 class="img-responsive" alt="">
                                                        </div>
                                                        <div class="grid-img">
                                                            <img src="{{asset('/')}}front-end/images/p23.jpg"
                                                                 class="img-responsive" alt="">
                                                        </div>
                                                    </a>
                                                </figure>
                                        ...
                                        <div class="grid-arr">
                                            <div class="grid-arrival">
                                                <figure>
                                                    <a href="single.html">
                                                        <div class="grid-img">
                                                            <img src="{{asset('/')}}front-end/images/p26.jpg"
                                                                 class="img-responsive" alt="">
                                                        </div>
                                                        <div class="grid-img">
                                                            <img src="{{asset('/')}}front-end/images/p25.jpg"
                                                                 class="img-responsive" alt="">
                                                        </div>
                                                    </a>
                                                </figure>
                                        ...
                                        <div class="grid-arr">
                                            <div class="grid-arrival">
                                                <figure>
                                                    <a href="single.html">
                                                        <div class="grid-img">
                                                            <img src="{{asset('/')}}front-end/images/p10.jpg"
                                                                 class="img-responsive" alt="">
                                                        </div>
                                                        <div class="grid-img">
                                                            <img src="{{asset('/')}}front-end/images/p9.jpg"
                                                                 class="img-responsive" alt="">
                                                        </div>
                                                    </a>
                                                </figure>
                        ...
                        <div class="grid-arr">
                            <div class="grid-arrival">
                                <figure>
                                    <a href="single.html">
                                        <div class="grid-img">
                                            <img src="{{asset('/')}}front-end/images/p28.jpg" class="img-responsive"
                                                 alt="">
                                        </div>
                                        <div class="grid-img">
                                            <img src="{{asset('/')}}front-end/images/p27.jpg" class="img-responsive"
                                                 alt="">
                                        </div>
                                    </a>
                                </figure>
                        ...
                        <div class="grid-arr">
                            <div class="grid-arrival">
                                <figure>
                                    <a href="single.html">
                                        <div class="grid-img">
                                            <img src="{{asset('/')}}front-end/images/p30.jpg" class="img-responsive"
                                                 alt="">
                                        </div>
                                        <div class="grid-img">
                                            <img src="{{asset('/')}}front-end/images/p29.jpg" class="img-responsive"
                                                 alt="">
                                        </div>
                                    </a>
                                </figure>
                        ...
                        <div class="grid-arr">
                            <div class="grid-arrival">
                                <figure>
                                    <a href="single.html">
                                        <div class="grid-img">
                                            <img src="{{asset('/')}}front-end/images/s2.jpg" class="img-responsive"
                                                 alt="">
                                        </div>
                                        <div class="grid-img">
                                            <img src="{{asset('/')}}front-end/images/s1.jpg" class="img-responsive"
                                                 alt="">
                                        </div>
                                    </a>
                                </figure>
                        ...
                        <div class="grid-arr">
                            <div class="grid-arrival">
                                <figure>
                                    <a href="single.html">
                                        <div class="grid-img">
                                            <img src="{{asset('/')}}front-end/images/s4.jpg" class="img-responsive"
                                                 alt="">
                                        </div>
                                        <div class="grid-img">
                                            <img src="{{asset('/')}}front-end/images/s3.jpg" class="img-responsive"
                                                 alt="">
                                        </div>
                                    </a>
                                </figure>
